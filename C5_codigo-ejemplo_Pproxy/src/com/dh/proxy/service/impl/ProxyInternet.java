...
//3) definimos el proxy, que realiza lo mismo que InternetService pero
//agrega logica extra
public class ProxyInternet implements IConexionInternet {
 ...
 //LOGICA EXTRA:
 // Si la url a la que nos queremos conectar, no esta
 // en la lista de sitios bloqueados, nos conectamos.
    @Override
